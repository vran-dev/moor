...
export const ResizableView = (props: ResizableHandleProps): JSX.Element => {
    ...
    const onMouseDown = (e: MouseEvent, type: ResizableHandleType): void => {
        ...
        const startWidth =
            resizableViewRef.current?.getBoundingClientRect().width || 0
        const startHeight =
            resizableViewRef.current?.getBoundingClientRect().height || 0
    ...
    return (
        <div
            ...
            style={{
                ...
                width: `${
                    props.initialSize.width
                        ? props.initialSize.width + 'px'
                        : 'inherit'
                }`,
                height: `${
                    props.initialSize.height
                        ? props.initialSize.height + 'px'
                        : 'inherit'
                }`,
                maxWidth: '100%'
            }}
        ...
        >
            <div
                ...
                ref={leftHandleRef}
                onMouseDown={(e): void =>
                    onMouseDown(e, ResizableHandleType.Left)
                }
            >
                <div
                    style={{
            ...
            <div
                ...
                ref={rightHandleRef}
                onMouseDown={(e): void =>
                    onMouseDown(e, ResizableHandleType.Right)
                }
            >
                <div
                    style={{
            ...
            {aspectRatio === ResizableRatioType.Flexible && (
                <>
                    <div
                        ...
                        ref={bottomHandleRef}
                        onMouseDown={(e): void =>
                            onMouseDown(e, ResizableHandleType.Bottom)
                        }
                    >
                        <div
                            style={{
                    ...
                    <div
                        ...
                        onMouseDown={(e): void =>
                            onMouseDown(e, ResizableHandleType.BottomLeft)
                        }
                    >
                        <div
                            style={{
                    ...
                    <div
                        ...
                        onMouseDown={(e): void =>
                            onMouseDown(e, ResizableHandleType.BottomRight)
                        }
                    >
                        <div
                            style={{
